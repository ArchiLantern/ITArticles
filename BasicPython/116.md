...
第一个值是0；第二个是start+1*step，将上面的数代入，应该是1,但是最后一个还是-9，好像出现问题了。。
But 数学这么严谨的科学怎么能随便用“好像”“应该”呢？。。再说了，The Zen of Python 都说了 Errors should never pass silently. 让我们大胆试验，看看 range()到底是怎么运行的。请看下面代码实验、结果和注释：
